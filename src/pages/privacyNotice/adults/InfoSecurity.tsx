...
const InfoSecurity: FC<InfoSecurityProps> = () => (
  <>
    <Typography>
      We have security measures in place to prevent personal information from
      being accidentally lost, or used or accessed in an unauthorised way. We
      limit access to your personal information to those persons who have a
      genuine business need to know it and we require them to keep it
      confidential.
    </Typography>
    <Typography>
