...
const HowToComplain: FC<HowToComplainProps> = () => (
  <>
    <Typography>
      We hope that we or our Data Protection Officer can resolve any query or
      concern you raise about this Privacy Notice or how we use your
      information.
    </Typography>
    <Typography mb={0}>
      Alternatively, you also have the right to lodge a complaint with a data
      protection authority, in particular in the UK and/or the and/or the
      European Union (or European Economic Area) country where you work,
