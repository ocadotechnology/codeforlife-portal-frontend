...
const RapidRouter: FC<RapidRouterProps> = () => (
  <>
    ...
    <Typography>
      Whether you’re a parent, teacher or a student, our games support and guide
      you, making learning to code great fun. Get started with Rapid Router
      designed for students new to coding. Rapid Router is where you will build
      up your ability.
    </Typography>
    <Image
    ...
    >
      <Typography>
        Starting with Blockly, you can learn to become a coding superhero, amaze
        your friends with your high scores. Create levels for your friends and
